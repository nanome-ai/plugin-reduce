...
class ReducePlugin(nanome.AsyncPluginInstance):
    ...
    async def add_hydrogens(self, request=None, complexes=None):
        ...
        for complex in complexes:
            ...
            result_complex, hydrogen_ids = await call_Reduce(self.input_file.name, self.output_file)
...
async def call_Reduce(pdb_path, output_pdb):
    ...
    p.args = ["-DB", "\"" + REDUCE_DICT_PATH + "\"", pdb_path]
